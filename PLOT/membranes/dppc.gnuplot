...
plot 'data/dppc_40x40_GAMMA_sorted.dat' u (-$1):2 with linespoints lc 7 lw 3 t'',\
...
set xtics 5
set ytics 0.02
set key at screen 0.15, 0.75 
plot      'dppc_large/lx.dat' u ($1*0.03/1000):(0.64+$2*0.) w l lw 3  dt 2 lc 8 t 'exp',\
	  'dppc_large/lx.dat' u ($1*0.03/1000):($2**2/(33282/2)) w l lw 3 lc 7   t 'sim' ,\
