...
#          KAPPA PART  #
########################
set terminal epslatex size 1.7,1.3 font "cmss,10" standalone header "\\usepackage{siunitx}"
#set terminal epslatex size 2.,1.5 font ",10" standalone header '\usepackage{siunitx} '
...
set ylabel '$P/\si{kbar}$'
set xlabel '$\kappa/\si{kJ^{-1}.mol}$'
plot  'PRESSURE_DATA_TEMP_300/pressavg_mean.dat' u ($1):($2/1E8) w linespoints lw 4 lc 7 t ''
...
set xlabel '$\kappa/\si{kJ^{-1}.mol}$'
plot [0.015:0.105] "data/PRESSURE_DATA_TEMP_300_a.dat" u 1:2 w p lw 4 lc 7 t '',\
     [0.015:0.105] "data/PRESSURE_DATA_TEMP_300_a_FIT.dat" u 1:2 w l lw 4 lc 7 t ''#$a=8.54+18.61\kappa$'
...
set xtics 10
set key at 340, 9.35 
plot "data/PRESSURE_DATA_KOMP_0.05_a.dat" u 1:2 w p lw 3 lc 7 t '$a_{0.05}=8.40+0.00367T$',\
     "data/PRESSURE_DATA_KOMP_0.05_a_FIT.dat" u 1:2 w l lw 3 lc 7 t '',\
     "data/PRESSURE_DATA_KOMP_0.03_a.dat" u 1:2 w p lw 3 lc 8 t '$a_{0.03}=8.30+0.00296T$',\
     "data/PRESSURE_DATA_KOMP_0.03_a_FIT.dat" u 1:2 w l lw 3 lc 8 t ''
 
# PLOT DENSITY  AS FUNCTION OF KAPPA 
set ytics 0.1
set xtics 0.5
set output "dens_kappa_water.tex"
set ylabel '$\rho/10^3\si{kg.m^{-3}}$'
set xlabel '$t/\si{ns}$'
set yrange [0.95:1.2]
set xrange [0:1.]
set key at 0.925, 1.175
set key samplen 1.5
plot 'PRESSURE_DATA_EQUIL/dens.dat' u ($1*0.03*0.001):($2/1000) w l dt 1 lw 4 lc 7 t '\footnotesize$\kappa=0.03$',\
     'PRESSURE_DATA_EQUIL/dens.dat' u ($3*0.03*0.001):($4/1000) w l dt 2 lw 4 lc 8 t '\footnotesize$\kappa=0.05$',\
     'PRESSURE_DATA_EQUIL/dens.dat' u ($5*0.03*0.001):($6/1000) w l dt 3 lw 4 lc 6 t '\footnotesize$\kappa=0.10$'
