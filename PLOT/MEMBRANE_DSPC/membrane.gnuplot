...
plot 'PRESSURE_DATA/pressavg_mean.dat' u (-$1):($2/1E5) w p lw 2 lc 1 t '',\
     '< sort -nk1 PRESSURE_DATA/pressavg_mean.dat' u   (-$1):(P(-$1)) w l lw 2 lc 1 t title_p(a3,b3,c3),\
     'PRESSURE_DATA/pressxxavg_mean.dat' u (-$1):($2/1E5) w p lw 2 lc 2 t '',\
     '< sort -nk1 PRESSURE_DATA/pressxxavg_mean.dat' u   (-$1):(Pxx(-$1)) w l lw 2 lc 2 t title_pxx(a2,b2,c2),\
     'PRESSURE_DATA/presszzavg_mean.dat' u (-$1):($2/1E5) w p lw 2 lc 3 t '',\
     '< sort -nk1 PRESSURE_DATA/presszzavg_mean.dat' u   (-$1):(Pzz(-$1)) w l lw 2 lc 3 t title_pzz(a1,b1,c1)
...
plot 'PRESSURE_DATA/klm_a.dat' u (-$1):2 w p lw 2 t '',\
     '< sort -nk1 PRESSURE_DATA/klm_a.dat' u (-$1):(kompT(-$1)) w l lw 2 t title_f(a4,b4,c4)
